...
class AccDlg(wx.Frame):
    ...
    def __init__(self, parent, id, stat):
        wx.Frame.__init__(self, parent, id, u'加速度通道选择', size = (500, 360), style = wx.CAPTION | wx.CLOSE_BOX)
        self.panel = wx.Panel(self, -1, pos = (0, 0), style = wx.NO_FULL_REPAINT_ON_RESIZE)

        self.DlgStat = stat
        self.framestat = 0

        title = wx.StaticText(self.panel, -1, u'请选择四个通道来显示', (100, 20), (-1, -1), wx.ALIGN_CENTER)
        title.SetForegroundColour('#0969A2')
        font = wx.Font(22, wx.SWISS, wx.NORMAL, wx.BOLD, underline = False, faceName = 'Microsoft YaHei')
        title.SetFont(font)
    ...
    def DisplayButton(self):
        ...
        bmp = wx.Image('GenerateAccPlot_Resize_1.png', wx.BITMAP_TYPE_PNG).ConvertToBitmap()

        butStart = wx.Button(self.panel, -1, u'生成图像', (80, 180))
        butStart.SetFont(wx.Font(14, wx.SWISS, wx.NORMAL, wx.BOLD, underline = False, faceName = 'Microsoft YaHei'))
...
class ChChosse(object):
    ...
    def DisplayCombobox(self, panel, posid):
        ...
        chselect = wx.StaticText(panel, -1, u'请选择一个通道', (20 + (posid - 1) * 120, 90), (-1, -1),
                                    wx.ALIGN_CENTER)
