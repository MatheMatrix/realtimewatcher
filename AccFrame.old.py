...
class AccFrame(wx.Frame):
    ...
    def __init__(self, parent, id):  # , stat):
        ...
        wx.Frame.__init__(self, parent, id, u'加速度实时监控', size=(1083, 720),
    ...
    def DisplayTitle(self, panel):
        ...
        title = wx.StaticText(
            panel, -1, u'加速度实时监控系统', (433, 50), (-1, -1), wx.ALIGN_CENTER)
...
class AccPlot():
    ...
    chtypes = {1: ['ch1', 'ch2', 'ch3', 'ch4', 'ch5', 'ch6', 'ch7', 'ch8', 'ch9', 'ch10', 'ch11'], 2: ['ch12', 'ch13', 'ch14', 'ch15', 'ch16', 'ch17', 'ch18', 'ch19', 'ch20', 'ch21', 'ch22'], 3:
               ['ch22', 'ch23', 'ch24', 'ch25', 'ch26', 'ch27', 'ch28', 'ch29', 'ch30', 'ch31', 'ch32', 'ch33'], 4: ['ch32', 'ch33', 'ch34', 'ch35', 'ch36', 'ch37', 'ch38', 'ch39', 'ch40', 'ch41', 'ch42', 'ch43', 'ch44']}
    ...
    def DisplayCombobox(self, panel, posid):
        ...
        chselect = wx.StaticText(panel, -1, u'请选择一个通道', (
            955, 70 + (posid - 1) * 140), (-1, -1), wx.ALIGN_CENTER)
        ...
        cb = wx.ComboBox(
            panel, -1, self.chtypes[posid][0], (957, 90 + (posid - 1) * 140),
    ...
    def initplot(self, panel, posid):
        ...
        self.axes.set_position(
            [0.03, 0.75 - (posid - 1) * (0.17 + 0.04), 0.95, 0.17])
